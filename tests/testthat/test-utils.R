...
describe("getData for Big Spectronaut", {
  ...
  test_that("Valid input returns data", {
    ...
    res <- getData(mock_input_big, big_file_path_spec = "test.csv")
  ...
  test_that("Invalid qvalue_cutoff returns NULL", {
    ...
    res <- getData(bad_input, big_file_path_spec = "test.csv")
    expect_null(res)
  })
  ...
  test_that("File not found returns NULL", {
    ...
    res <- getData(mock_input_big, big_file_path_spec = "nonexistent.csv")
    expect_null(res)
  })
...
describe("getData for Big DIANN", {
  ...
  test_that("Valid input returns data", {
    ...
    res <- getData(mock_input_big_diann, big_file_path_diann = "test.csv")
    expect_equal(res, mock_df)
  })
  ...
  test_that("Invalid max_feature_count returns NULL", {
    ...
    res <- getData(bad_input, big_file_path_diann = "test.csv")
    expect_null(res)
  })
  ...
  test_that("File not found returns NULL", {
    ...
    res <- getData(mock_input_big_diann, big_file_path_diann = "nonexistent.csv")
    expect_null(res)
  })
