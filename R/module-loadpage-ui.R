loadpageUI <- function(id) {
  ...
  to format your data please see the MSstatsPTM ", 
      ...
      sidebarPanel(
        ...
        tags$hr(),
        conditionalPanel(
          condition = "input['loadpage-filetype'] == 'sample' && input['loadpage-DDA_DIA'] == 'PTM'",
          h4("3. TMT Experiment"),
        ...
        conditionalPanel(
          condition = "input['loadpage-filetype'] =='10col' || input['loadpage-filetype'] =='prog' || input['loadpage-filetype'] =='PD' || input['loadpage-filetype'] =='open'||
                   input['loadpage-filetype'] =='openms' || input['loadpage-filetype'] =='spmin'",
        ...
        conditionalPanel(
          condition = "input['loadpage-filetype'] && input['loadpage-filetype'] != 'maxq' && input['loadpage-filetype'] != 'sample' && input['loadpage-filetype'] != 'ump' && input['loadpage-filetype'] != 'MRF' && input['loadpage-filetype'] != 'spec' && input['loadpage-filetype'] != 'spmin' && input['loadpage-filetype'] != 'phil'",
