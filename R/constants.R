...
NAMESPACE_STATMODEL = list(
  ...
  visualization_volcano_which_comparison = "visualization_volcano_which_comparison", # WhichComp
  ...
  visualization_comparison_plot_which_comparison = "visualization_comparison_plot_which_comparison", # WhichComp1
