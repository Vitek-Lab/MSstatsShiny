help = fluidPage(
  ...
  p("MSstats takes input data in a tabular .csv format derived from any \
    spectral processing tool such as Skyline, SuperHirn, MaxQuant, Progenesis, \
    MultiQuant, OpenMS or OpenSWATH.  These formats can be converted to the \
    required 10-column format through specific commands.  Conversion of formats\
    Skyline, MaxQuant, Progenesis, and Proteome Discoverer requires annotation \
    files. The annotation file must be in a specific format. For help building \
    the annotation file please see the MSstats and MSstatsTMT Vignettes \
    located in the help section of MSstats-Shiny."),
  ...
  tags$br(),
  h5(HTML('<b>Tab : Data Summarization</b>')),
  ...
  tags$br(),
  h5(HTML('<b>Tab : Future Experiments</b>')),
